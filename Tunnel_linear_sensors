...
Y=5 #tunnel length
Z=4.8 #tunnel height
cx=0.1 #cell size in x
cy=0.1 #cell size in y
cz=0.1 #cell size in z

#Parametrization equation of tunnel shape with Excel interpolation
